...
/* AcmebsceneBundle:Account:new.html.twig */
class __TwigTemplate_b51203a1b881e5eab16b69ec8202b40e6628e82053d1bc1e7ebc00c923a3e9e7 extends Twig_Template
{
    ...
    <table>
        ...
        <tr>
            <th class=\"text-right\">";
        // line 35
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "backupEmail", array()), 'label');
        echo "</th>
            <td class=\"text-left\">";
        // line 36
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "backupEmail", array()), 'widget');
        echo "</td>
            <td class=\"text-left\">";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "backupEmail", array()), 'errors');
        echo "</td>
        </tr>
        <tr>
            <th class=\"text-right\">";
        // line 40
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "businessPhone", array()), 'label');
        echo "</th>
            <td class=\"text-left\">";
        // line 41
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "businessPhone", array()), 'widget');
        echo "</td>
            <td class=\"text-left\">";
        // line 42
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "businessPhone", array()), 'errors');
        echo "</td>
        </tr>
        <tr>
            <th class=\"text-right\">";
        ...
        echo "</td>
            <td class=\"text-left\">";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "address1", array()), 'errors');
        echo "</td>
        </tr>        
        <tr>
            <th class=\"text-right\">";
        ...
        echo "</td>
            <td class=\"text-left\">";
        // line 57
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "address2", array()), 'errors');
        echo "</td>
        </tr>
        <tr>
            <th class=\"text-right\">";
        // line 60
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "province", array()), 'label');
        echo "</th>
            <td class=\"text-left\">";
        // line 61
        ...
        echo "</td>
            <td class=\"text-left\">";
        // line 62
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "province", array()), 'errors');
        echo "</td>
        </tr>
    </table>
...
";
    ...
    {
        return "AcmebsceneBundle:Account:new.html.twig";
    }
    ...
    {
        return array (  210 => 68,  201 => 62,  197 => 61,  193 => 60,  187 => 57,  183 => 56,  179 => 55,  173 => 52,  169 => 51,  165 => 50,  159 => 47,  155 => 46,  151 => 45,  145 => 42,  141 => 41,  137 => 40,  131 => 37,  127 => 36,  123 => 35,  117 => 32,  113 => 31,  109 => 30,  103 => 27,  99 => 26,  95 => 25,  89 => 22,  85 => 21,  81 => 20,  75 => 17,  71 => 16,  67 => 15,  61 => 12,  57 => 11,  53 => 10,  46 => 6,  42 => 5,  39 => 4,  36 => 3,  11 => 1,);
    }
}
