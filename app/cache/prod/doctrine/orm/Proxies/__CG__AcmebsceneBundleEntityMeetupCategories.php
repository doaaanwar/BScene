 ...
 */
class MeetupCategories extends \Acme\bsceneBundle\Entity\MeetupCategories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MeetupCategories $proxy) {
