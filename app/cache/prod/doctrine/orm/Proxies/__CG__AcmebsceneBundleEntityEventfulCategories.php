 ...
 */
class EventfulCategories extends \Acme\bsceneBundle\Entity\EventfulCategories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventfulCategories $proxy) {
